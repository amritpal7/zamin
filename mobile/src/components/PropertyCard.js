      ...
      <View style={{
        ...
        <View style={{ paddingHorizontal: 18, paddingVertical: 14, flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
            ...
            <Text numberOfLines={1} style={{ color: !isOwn && p.owner_active === false ? C.red : C.fgDim, fontSize: 11, fontFamily: FONT, flexShrink: 1 }}>
              {isOwn ? "Me" : p.owner_name}{!isOwn && p.owner_username ? ` @${p.owner_username}` : ""}{p.verified && !isOwn ? " ✓" : ""}
            </Text>
        ...
        {/* Liquid-glass top-edge sheen (subtle rim light) — iOS/web only; Android is solid. */}
        {Platform.OS !== "android" && (
          <LinearGradient
